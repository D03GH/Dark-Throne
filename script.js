...
function showIntroMenu() {
    ...
    titleLabel.textContent = "Dark Throne";
    textLabel.textContent = "Welcome to Dark Throne, where your choices shape the fate of your kingdom. Every decision you make will test your morality, greed, and selfishness. Will you rule with an iron fist, or show mercy to your subjects? The choice is yours, but remember: power always comes at a price.";
...
function exitGame() {
    if (confirm("Are you sure you want to exit the game?")) {
        ...
        document.body.innerHTML = "<h1>Thank you for playing Dark Throne</h1>";
    }
}
